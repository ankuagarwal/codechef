...
int r, c;
char input [51][51];
int LeftHorizontalCount [52][52];
int RightHorizontalCount [52][52];
int TopVerticalCount [52][52];
int BottomVerticalCount [52][52];
